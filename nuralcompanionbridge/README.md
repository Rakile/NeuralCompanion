...
```json
{
  ...
  "vam_vmc_port": 39539,
  "vam_bridge_enabled": true,
  "vam_bridge_root": "D:/tools/python_scripts/VaM 1.20.0.6/Custom/PluginData/NeuralCompanionBridge",
  "vam_play_audio_in_vam": true,
...
```json
{
  ...
  "payload": {
    ...
    "audio_path": "D:/tools/python_scripts/VaM 1.20.0.6/Custom/PluginData/NeuralCompanionBridge/audio/speech_1.wav",
