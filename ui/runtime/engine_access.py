"""Shared engine access facade for runtime-backed UI modules.

This keeps UI runtime mixins from importing ``engine`` directly while preserving
their existing call shapes during the migration.
"""
