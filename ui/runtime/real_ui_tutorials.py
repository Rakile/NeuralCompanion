...
class MainUiRealTutorialMixin:
    ...
    def _start_tutorial_from_ui_real(self, tutorial_id):
            ...
            if not payload:
                ...
                return
            debug_enabled = bool(getattr(tutorial_framework, "tutorial_debug_enabled", lambda _payload=None: False)(payload))
            if debug_enabled:
    ...
    def _on_frontend_tutorial_finished(self, reason):
            if bool(getattr(tutorial_framework, "tutorial_debug_enabled", lambda _payload=None: False)()):
