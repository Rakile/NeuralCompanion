...
class BackendOperationalPanelMixin:
    ...
    def _build_right_panel(self):
        ...
        self.chat_timestamp_toggle_button = QtWidgets.QPushButton("Timestamps: Off")
        self.chat_timestamp_toggle_button.setObjectName("chat_timestamp_toggle_button")
        self.chat_timestamp_toggle_button.clicked.connect(self.toggle_chat_message_timestamps)
        chat_header.addWidget(self.chat_timestamp_toggle_button)
        ...
        self.identity_relay_chat_row = QtWidgets.QWidget()
        self.identity_relay_chat_row.setObjectName("identity_relay_chat_row")
        identity_relay_layout = QtWidgets.QHBoxLayout(self.identity_relay_chat_row)
        identity_relay_layout.setContentsMargins(0, 0, 0, 0)
        self.identity_relay_toggle = QtWidgets.QCheckBox("Identity Relay")
        self.identity_relay_toggle.setObjectName("identity_relay_toggle")
        identity_relay_layout.addWidget(self.identity_relay_toggle)
        self.identity_relay_status_label = QtWidgets.QLabel()
        self.identity_relay_status_label.setObjectName("identity_relay_status_label")
        self.identity_relay_status_label.setWordWrap(True)
        identity_relay_layout.addWidget(self.identity_relay_status_label)
        self.identity_relay_judging_label = QtWidgets.QLabel("Evaluating Identity Relay continuity...")
        self.identity_relay_judging_label.setObjectName("identity_relay_judging_label")
        self.identity_relay_judging_label.setVisible(False)
        identity_relay_layout.addWidget(self.identity_relay_judging_label)
        self.identity_relay_warning_label = QtWidgets.QLabel()
        self.identity_relay_warning_label.setObjectName("identity_relay_warning_label")
        self.identity_relay_warning_label.setWordWrap(True)
        identity_relay_layout.addWidget(self.identity_relay_warning_label, 1)
        self.identity_relay_repair_button = QtWidgets.QPushButton("Repair")
        self.identity_relay_repair_button.setObjectName("identity_relay_repair_button")
        self.identity_relay_repair_button.setVisible(False)
        identity_relay_layout.addWidget(self.identity_relay_repair_button)
        self.identity_relay_disable_button = QtWidgets.QPushButton("Disable")
        self.identity_relay_disable_button.setObjectName("identity_relay_disable_button")
        self.identity_relay_disable_button.setVisible(False)
        identity_relay_layout.addWidget(self.identity_relay_disable_button)
        self.identity_relay_rebuild_index_button = QtWidgets.QPushButton("Rebuild Index")
        self.identity_relay_rebuild_index_button.setObjectName("identity_relay_rebuild_index_button")
        self.identity_relay_rebuild_index_button.setVisible(False)
        identity_relay_layout.addWidget(self.identity_relay_rebuild_index_button)
        self.identity_relay_trace_button = QtWidgets.QPushButton("Trace")
        self.identity_relay_trace_button.setObjectName("identity_relay_trace_button")
        self.identity_relay_trace_button.setVisible(False)
        identity_relay_layout.addWidget(self.identity_relay_trace_button)
        self.identity_relay_chat_row.setVisible(False)
        ...
        self.chat_edit.verticalScrollBar().valueChanged.connect(self._on_chat_scroll_value_changed)
        chat_layout.addLayout(chat_header)
        chat_layout.addWidget(self.identity_relay_chat_row)
        ...
        self.btn_start.setSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        ...
        self.btn_stop.setSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        ...
        self.btn_reset.setSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
