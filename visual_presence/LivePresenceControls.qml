...
Item {
    ...
    Column {
        ...
        Column {
            ...
            PresenceSlider { label: "Drift"; settingKey: "ai_presence_idle_motion_strength"; value: presenceBridge ? presenceBridge.idleMotionStrength : 0.16; minValue: 0.0; maxValue: 1.0; presenceBridge: panel.presenceBridge }
