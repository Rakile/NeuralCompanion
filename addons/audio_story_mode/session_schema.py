...
LEGACY_FIELD_PATHS = OrderedDict(
    (
        ...
        ("audio_story_mode_audio_paths", ("audio", "audio_paths")),
        ("audio_story_mode_audio_sources", ("audio", "audio_sources")),
        ("audio_story_mode_project_id", ("project", "project_id")),
        ("audio_story_mode_project_revision", ("project", "revision")),
        ("audio_story_mode_playback_mode", ("audio", "playback_mode")),
        ("audio_story_mode_transcribe_seconds", ("audio", "transcribe_seconds")),
        ("audio_story_mode_selected_range_enabled", ("audio", "selected_range_enabled")),
        ...
        ("audio_story_mode_tts_startup_buffer_seconds", ("audio", "tts_startup_buffer_seconds")),
        ("audio_story_mode_tts_render_ahead_seconds", ("audio", "tts_render_ahead_seconds")),
        ...
        ("audio_story_mode_instructor_beats_enabled", ("analysis", "instructor_beats_enabled")),
