...
If recent retained hidden PONG context already contains a very similar warning for the same heart-rate state, prefer should_speak=false to avoid repetitive nagging.
