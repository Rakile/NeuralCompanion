...
If recent retained hidden PONG context already contains a very similar comment for the same clipboard image, prefer should_speak=false to avoid repetition.
